---- MODULE SyncTimeline_TTrace_1785773274 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SyncTimeline_TTrace_1785773274.json", _TETrace)
...
\*
\*trace == IODeserialize("SyncTimeline_TTrace_1785773274.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SyncTimeline_TTrace_1785773274 ----
CONSTANTS
    Clients = { c1 , c2 }
    MaxSeq = 3
    MaxEpoch = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 11:07:55 CDT 2026