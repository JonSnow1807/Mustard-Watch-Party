---- MODULE SyncTimeline_TTrace_1785773357 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SyncTimeline_TTrace_1785773357.json", _TETrace)
...
\*
\*trace == IODeserialize("SyncTimeline_TTrace_1785773357.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SyncTimeline_TTrace_1785773357 ----
CONSTANTS
    Clients = { c1 , c2 }
    MaxSeq = 3
    MaxEpoch = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Aug 03 11:09:17 CDT 2026